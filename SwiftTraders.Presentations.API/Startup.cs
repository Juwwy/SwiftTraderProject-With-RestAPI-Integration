...
namespace SwiftTraders.Presentations.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SwiftTraders.Presentations.API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<Users> userManager, RoleManager<IdentityRole> roleManager, SwiftTraderDbContext dbContext)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SwiftTraders.Presentations.API v1");
